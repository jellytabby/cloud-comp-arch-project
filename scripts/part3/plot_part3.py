...
def main():
    ...
    parser.add_argument("--dir", default="./results/part3/version4.3/",
                        help="Directory containing run1.json, run2.json, run3.json")
    parser.add_argument("--measurements", default="./results/part3/version4.3/measurements.txt",
                        help="Single mcperf measurement file covering all runs")
    parser.add_argument("--output", default="plots/part3/version4.3/",
