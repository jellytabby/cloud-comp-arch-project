...
declare -A barnes_map=(["nodetype"]="node-b-4core" ["threads"]="4" ["cpus"]="0-3")  # Remains same as before
declare -A blackscholes_map=(["nodetype"]="node-b-4core" ["threads"]="4" ["cpus"]="0-3")  # Remains same as before
declare -A canneal_map=(["nodetype"]="node-b-4core" ["threads"]="4" ["cpus"]="0-3")  # Remains same as before
declare -A freqmine_map=(["nodetype"]="node-a-8core" ["threads"]="8" ["cpus"]="0-7")  # Remains same as before
declare -A radix_map=(["nodetype"]="node-a-8core" ["threads"]="8" ["cpus"]="0-7")  # Changed to node-a-8core for low memBW
declare -A streamcluster_map=(["nodetype"]="node-a-8core" ["threads"]="4" ["cpus"]="0-3")  # Changed to node-a-8core to reduce interference
declare -A vips_map=(["nodetype"]="node-a-8core" ["threads"]="3" ["cpus"]="0-2")  # Changed to node-a-8core for low memBW
