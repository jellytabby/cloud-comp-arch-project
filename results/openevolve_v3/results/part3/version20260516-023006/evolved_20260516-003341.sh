...
# 
# Consider adjusting vips to use 3 threads instead of 3 to reduce contention on node-b-4core
# 6. Ensure blackscholes and canneal have different CPU cores to reduce interference
# 
declare -A barnes_map=(["nodetype"]="node-b-4core" ["threads"]="4" ["cpus"]="0-3")
declare -A blackscholes_map=(["nodetype"]="node-b-4core" ["threads"]="4" ["cpus"]="1-4")  # Use separate cores for blackscholes and canneal
declare -A canneal_map=(["nodetype"]="node-b-4core" ["threads"]="4" ["cpus"]="2-5")  # Use separate cores for canneal
